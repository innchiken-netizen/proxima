...
def main():
    ...
    fit_to_square(lotion_bottle_studio or woman_lotion_1, 'proxima-lotion-pink.jpg')
    fit_to_square(oil_bottle_studio or woman_body_oil, 'proxima-oil-pink.jpg')
    fit_to_square(face_cream_user, 'proxima-cream-pink.jpg')
    fit_to_square(routine_wash, 'proxima-gel-pink.jpg')
    fit_to_square(face_cream_user, 'proxima-set-pink.jpg')
    
    fit_to_square(woman_lotion_2 or lotion_bottle_studio, 'proxima-lotion-brown.jpg')
    fit_to_square(woman_body_oil or oil_bottle_studio, 'proxima-oil-brown.jpg')
    fit_to_square(face_cream_user, 'proxima-cream-brown.jpg')
    fit_to_square(savon_noir, 'proxima-gel-brown.jpg')
    fit_to_square(face_cream_user, 'proxima-set-brown.jpg')
    
    fit_to_square(lotion_bottle_studio or woman_lotion_1, 'proxima-lotion-green.jpg')
    fit_to_square(oil_bottle_studio or woman_body_oil, 'proxima-oil-green.jpg')
    fit_to_square(face_cream_user, 'proxima-cream-green.jpg')
    fit_to_square(routine_wash, 'proxima-gel-green.jpg')
    fit_to_square(set_green, 'proxima-set-green.jpg')
